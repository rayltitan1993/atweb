...
const impressumContent = `## Legal Notice (Impressum)
...
export default async function ImpressumPage() {
  const content = await markdownToHtml(impressumContent);

  return (
    <main>
      <Container>
        <article className="py-16 max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-8">Legal Notice (Impressum)</h1>
